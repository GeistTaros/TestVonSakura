...
define config.name = _("Test von Sakura")
...
init python:
    if renpy.variant("mobile"):
        config.version = "1.090.mobile"
    else:
        config.version = "1.090"
...
define gui.about = _p("""{color=#db17a1}Entwickler:{/color}Geist {color=#db17a1}Skript:{/color}Geist {color=#db17a1}Bilder:{/color}Geist{a=https://pixai.art/@taros}(Taros){/a}
    """)
...
define build.name = "Sakura_1.1.090"
...
define config.save_directory = "test-1696794224"
...
define config.window_icon = "gui/window_icon_sakura500x.png"
