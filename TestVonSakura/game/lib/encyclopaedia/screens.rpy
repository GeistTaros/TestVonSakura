        ...
        vbox:
            ...
            frame:
                ...
                hbox:
                    ...
                    text _("[enc.percentage_unlocked] % Komplett") style "encyclopaedia_header_text"
            ...
            frame:
                ...
                vbox:
                    ...
                    vbox:
                        text _("Sortierung") style "encyclopaedia_sorting_label_text"
                        hbox:
                            xfill True
        ...
        vbox:
            ...
            frame:
                ...
                hbox:
                    ...
                    textbutton _("←") xalign .02 action enc.PreviousEntry() style_suffix "change_entry_button"
                    textbutton _("→") xalign .98 action enc.NextEntry() style_suffix "change_entry_button"
            ...
            frame:
                ...
                if enc.active.has_pages:
                    hbox:
                        ...
                        textbutton _("←") xalign .02 action enc.PreviousPage() style "encyclopaedia_entry_change_entry_button"

                        # Flavour text to indicate which page out of the total is being viewed
                        $ total_pages = len(enc.active.pages)
                        text _("Seite [enc.active.current_page.page_number] / [total_pages]") style "encyclopaedia_entry_page_label"

                        textbutton _("→") xalign .98 action enc.NextPage() style "encyclopaedia_entry_change_entry_button"
            ...
            frame:
                ...
                hbox:
                    ...
                    textbutton _("Schließen") id "close_entry_button" xalign .98 clicked enc.CloseActiveEntry() style "encyclopaedia_close_button"
